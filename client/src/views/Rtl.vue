...
<script>
import Card from "@/main_components/Cards/Card.vue";
import DeveloperCard from "./components/DeveloperCard.vue";
import RocketCard from "./components/RocketCard.vue";
import ActiveUsersChart from "@/main_components/Charts/ActiveUsersChart.vue";
import GradientLineChart from "@/main_components/Charts/GradientLineChart.vue";
